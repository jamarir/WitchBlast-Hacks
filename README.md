...
To inject this cheat in the game, you must first launch `Witch Blast.exe`, downloadable [here](https://github.com/Cirrus-Minor/witchblast/releases/tag/v0.7.5), and inject [the release DLL](https://github.com/jamarir/WitchBlast-Hacks/releases) into the process using a [Dll Injector](https://github.com/adamhlt/DLL-Injector/releases/tag/DLL-Injector):
```
